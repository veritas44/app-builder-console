...
const MobileIcon = ({color}) => (
    <svg
      ...
      <defs>
        <style
          dangerouslySetInnerHTML={{__html: `.cls-1{fill:${color};}`}}
        />
      </defs>
...
const LivePeviewScreenTypeToggle = ({ livePreviewScreenType, handlePrevieTypeChange}) => {
    const ContentClasses = useContentStyles();
...
const LivePreview = () => {
    ...
    return (
        ...
        >
            <LivePreviewHeader livePreviewScreenType={livePreviewScreenType} handlePrevieTypeChange={handlePrevieTypeChange}/>
            <LivePreviewContent />
        </Grid>
    )
}
