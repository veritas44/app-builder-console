...
export default function Download(props: DownloadProps) {
  ...
  const download = async () => {
    ...
    if (AAB) {
        ...
        JSON.stringify(
          {
            ...
            illustration: props.configData.illustration
              ? 'illustration.jpg'
              : '',
      ...
      if (props.configData.logoSquare !== '') {
        ...
        if (dataURL) {
          AAB.file('logoSquare.jpg', dataURLtoFile(dataURL, 'logoSquare'), {
            binary: true,
          });
        }
      ...
      if (props.configData.logoRect !== '') {
        ...
        if (dataURL) {
          AAB.file('logoRect.jpg', dataURLtoFile(dataURL, 'logoRect'), {
            binary: true,
          });
        }
      ...
      if (props.configData.illustration !== '') {
        ...
        if (dataURL) {
          AAB.file('illustration.jpg', dataURLtoFile(dataURL, 'illustration'), {
            binary: true,
          });
        }
  ...
  return (
    <Button
      ...
      variant="contained"
      disabled={
        props.configData.APP_CERTIFICATE === '' || props.configData.AppID === ''
      }
      color="primary"
      onClick={download}
      disableElevation>
