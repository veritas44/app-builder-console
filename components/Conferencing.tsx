    ...
    return (
        <>
            ...
            <Box component="div" className={classes.SwitchContainer}>
                <Typography variant="caption"
                    className={classes.SwitchText}
                    component="p" style={{ marginRight: "auto" }}>
                    Precall Screen
                </Typography>
                <IOSSwitch
