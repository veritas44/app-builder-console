...
export default function Index() {
  ...
  const defaultState: ConfigInterface = {
    ...
    SUBHEADING:
      'Where business happens online, on time, each time.',
    encryption: false,
    ENABLE_GOOGLE_OAUTH: false,
  ...
  <defs>
    ...
    <pattern id="pattern" preserveAspectRatio="none" width="100%" height="100%" viewBox="0 0 1136 730">
      <image width="1136" height="730" xlink:href="${state.bg ? state.bg : defaultbg}"/>
    </pattern>
    <pattern id="pattern-2" preserveAspectRatio="none" width="100%" height="100%" viewBox="0 0 300 103">
      <image width="300" height="103" xlink:href="${state.logoRect ? state.logoRect : defultLogo}"/>
    </pattern>
  </defs>
  <g id="Group_501" data-name="Group 501" transform="translate(66 86)">
    ...
    <g id="Group_500" data-name="Group 500">
      ...
      <text id="Together_Business" data-name="Together Business" transform="translate(631 252)" dominant-baseline="middle" text-anchor="middle" fill=${state.primaryFontColor} font-size="25" font-family="Roboto-Bold, Roboto" font-weight="700">${state.HEADING}</text>
      <text id="Where_business_happens_online_on_time_each_time." data-name="Where business happens online, on time, each time." transform="translate(631 288)" fill=${state.primaryFontColor} font-size="17" font-family="Roboto-Medium, Roboto" font-weight="500" dominant-baseline="middle" text-anchor="middle">${state.SUBHEADING}</text>
      <g id="Group_494" data-name="Group 494" transform="translate(434 478.61)">
        <rect id="Rectangle_279" data-name="Rectangle 279" width="394" height="44" rx="22" transform="translate(0 0.39)" fill="${state.primaryColor}"/>
      ...
      <g id="Group_493" data-name="Group 493" transform="translate(434 605.777)">
        <g id="Rectangle_280" fill-opacity="0" data-name="Rectangle 280" transform="translate(0 0.223)" stroke="${state.primaryColor}" stroke-width="1">
          <rect width="394" height="45" rx="22.5" stroke="none"/>
          <rect x="0.5" y="0.5" width="393" height="44" rx="22" fill="none"/>
        </g>
        <text id="Meeting_ID_or_URL" data-name="Meeting ID or URL" transform="translate(183 26.223)" fill="${state.primaryColor}" font-size="14" font-family="Roboto-Medium, Roboto" font-weight="500"><tspan x="-56.561" y="0">Meeting ID or URL</tspan></text>
      </g>
      <g id="Group_492" data-name="Group 492" transform="translate(117 -39)">
        <text id="Use_PSTN_Join_by_dialing_a_number_" data-name="Use PSTN (Join by dialing a number)" transform="translate(407 489)" fill=${state.primaryFontColor} font-size="13" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">Use PSTN (Join by dialing a number)</tspan></text>
        <g id="Group_491" data-name="Group 491">
          <text id="Restrict_Host_Controls_Separate_host_link_" data-name="Restrict Host Controls (Separate host link)" transform="translate(407 458)" fill=${state.primaryFontColor} font-size="13" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">Restrict Host Controls (Separate host link)</tspan></text>
      ...
      <g id="Group_495" data-name="Group 495" transform="translate(434 336.776)">
        <g id="Component_2_7" data-name="Component 2 – 7" transform="translate(0 0.224)">
          <g id="Rectangle_278" fill-opacity="0" data-name="Rectangle 278" transform="translate(0 0)" fill="#fff" stroke="${state.primaryColor}" stroke-width="1">
            <rect width="395" height="44" rx="22" stroke="none"/>
            <rect x="0.5" y="0.5" width="394" height="43" rx="21.5" fill="none"/>
          </g>
        </g>
        <text id="AcmeMeeting" fill=${state.primaryFontColor} transform="translate(188 26.224)" font-size="14" font-family="Roboto-Medium, Roboto" font-weight="500"><tspan x="-43.788" y="0">AcmeMeeting</tspan></text>
      </g>
      <line id="Line_79" data-name="Line 79" x2="210" transform="translate(526.5 564.5)" fill="none" stroke="${state.primaryColor}" stroke-width="1" opacity="0.499"/>
    </g>
  </g>
</svg>
`,
                              ...
                              <g id="SVG_4" data-name="SVG – 4" clip-path="url(#clip-SVG_4)">
                                ...
                                <g id="Group_498" data-name="Group 498" transform="translate(-253.816 69.858)">
                                  ...
                                  <g id="Group_499" data-name="Group 499" transform="translate(-6)">
                                    ...
                                    <text id="Together_Business" data-name="Together Business" transform="translate(570 255)" fill=${state.primaryFontColor} font-size="23" font-family="Roboto-Bold, Roboto" font-weight="700" dominant-baseline="middle" text-anchor="middle">${state.HEADING}</text>
                                    <foreignObject width="280" height="200" style="transform: translate(433px, 254px)"
                                      requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility">
                                        <p style="text-align: center;font-size: 14px;line-height: 14px; margin-top:17px; color: ${state.primaryFontColor}" xmlns="http://www.w3.org/1999/xhtml">${state.SUBHEADING}</p>
                                    </foreignObject>
                                    <g id="Group_494" data-name="Group 494" transform="translate(430.686 432)">
                                      <rect id="Rectangle_279" data-name="Rectangle 279" width="287" height="35" rx="17.5" transform="translate(0.314 0)" fill="${state.primaryColor}"/>
                                    ...
                                    <g id="Group_493" data-name="Group 493" transform="translate(430.686 527)">
                                      <g id="Rectangle_280" fill-opacity="0" data-name="Rectangle 280" transform="translate(0.314 0)" stroke="${state.primaryColor}" stroke-width="0.5">
                                        <rect width="287" height="35" rx="17.5" stroke="none"/>
                                        <rect x="0.25" y="0.25" width="286.5" height="34.5" rx="17.25" fill="none"/>
                                      </g>
                                      <text id="Meeting_ID_or_URL" data-name="Meeting ID or URL" transform="translate(138.314 22)" fill="${state.primaryColor}" font-size="12" font-family="Roboto-Medium, Roboto" font-weight="500"><tspan x="-48.48" y="0">Meeting ID or URL</tspan></text>
                                    </g>
                                    <g id="Group_492" data-name="Group 492" transform="translate(479.538 373)">
                                      <text id="Use_PSTN_Join_by_dialing_a_number_" data-name="Use PSTN (Join by dialing a number)" transform="translate(21.462 33)" fill=${state.primaryFontColor} font-size="9" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">Use PSTN (Join by dialing a number)</tspan></text>
                                      <g id="Group_491" data-name="Group 491" transform="translate(0)">
                                        <text id="Restrict_Host_Controls_Separate_host_link_" data-name="Restrict Host Controls (Separate host link)" transform="translate(21.462 9)" fill=${state.primaryFontColor} font-size="9" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">Restrict Host Controls (Separate host link)</tspan></text>
                                    ...
                                    <g id="Group_495" data-name="Group 495" transform="translate(430.686 318)">
                                      <g id="Component_2_5" fill-opacity="0" data-name="Component 2 – 5" transform="translate(0.314 0)">
                                        <g id="Rectangle_278" data-name="Rectangle 278" transform="translate(0 0)" stroke=${state.primaryColor} stroke-width="0.5">
                                          <rect width="288" height="36" rx="18" stroke="none"/>
                                          <rect x="0.25" y="0.25" width="287.5" height="35.5" rx="17.75" fill="none"/>
                                          </g></g>
                                          <text id="Create_Meeting" data-name="Create Meeting" transform="translate(141.314 20)" fill=${state.primaryFontColor} font-size="12" font-family="Roboto-Medium, Roboto" font-weight="500" dominant-baseline="middle" text-anchor="middle">ACME Meeting</text>
                            `,
                            }}
                          />
                        </TabPanel>
